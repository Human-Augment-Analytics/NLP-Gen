            ...
            for entry in data:
                ...
                if len(keys) >= 2:  # Ensure there are at least two keys
                    extracted_data.append({
                        "date": entry[keys[0]],  # First key and its value
                        "date event": "TO_BE_FILLED_IN"        # Second key to be filled in
                    })
...
if __name__ == "__main__":
    input_folder = "3.extracted_dates_sample"
    output_folder = "4.extracted_dates_for_model"
