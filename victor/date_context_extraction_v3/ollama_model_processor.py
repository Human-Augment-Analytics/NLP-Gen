...
class OllamaModelProcessor:
    ...
    def _check_model_downloaded(self):
        ...
        check_model_command = f"/home/hice1/vfernandez8/Ollama/bin/ollama list | grep {self.model_name}"
        ...
        if self.model_name not in result.stdout:
            ...
            try:
                pull_model_command = f"/home/hice1/vfernandez8/Ollama/bin/ollama pull {self.model_name}"
    ...
    def _delete_model(self):
        # Delete the model
        delete_model_command = f"/home/hice1/vfernandez8/Ollama/bin/ollama rm {self.model_name}"
        try:
